...
Provides streaming support for PyBridge commands via Server-Sent Events (SSE).
...
class Channel(Generic[T]):
    ...
    The channel is automatically created and managed by PyBridge.
    """
...
class ChannelManager:
    ...
    async def create(self, channel_id: Optional[str] = None) -> Channel:
